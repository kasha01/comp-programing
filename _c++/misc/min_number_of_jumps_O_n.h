#ifndef MIN_NUMBER_OF_JUMPS_O_N_H_INCLUDED
#define MIN_NUMBER_OF_JUMPS_O_N_H_INCLUDED
...
int minJumps(int arr[], int n)
{
    ...
    for (i = 1; i < n; i++)
    {
        ...
        // we use a step to get to the current index. Steps is the count where my jump is not changing
        step--;
...
#endif // MIN_NUMBER_OF_JUMPS_O_N_H_INCLUDED
